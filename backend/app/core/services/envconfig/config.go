...
type Base struct {
	...
	JWTRefreshExpiration int64  `yaml:"JWT_REFRESH_EXPIRATION" env:"JWT_REFRESH_EXPIRATION"`
...
func (b *Base) GetJWTRefreshExpiration() int64 {
	return b.JWTRefreshExpiration
}
